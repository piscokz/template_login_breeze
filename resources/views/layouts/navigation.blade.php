@if (session()->has('status'))
    <div id="alert-border-5" x-data="{ isOpen: true }" x-show="isOpen"
        class="flex items-center p-4 bg-lime-300 dark:bg-lime-300" role="alert">
        <button type="button" @click="isOpen = false"
            ...
            <img src="{{ asset('asset/exit.png') }}" alt="Icon" width="20px">
        </button>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        @if (Auth::user()->level == 'admin' || Auth::user()->level == 'engineer')
                            <x-dropdown-link :href="route('profile.daftar')">
                                Daftar akun
                            </x-dropdown-link>
                        @endif
